...
class DynamicPDFController extends Controller
{
    ...
    {
     $customer_data = DB::table('customers')->limit(20)->get();
    ...
    <th style="border: 1px solid; padding:12px;" width="15%">Mobile</th>
     ...
     foreach($customer_data as $customer)
     {
      ...
      <tr>
       ...
       <td style="border: 1px solid; padding:12px;">'.$customer->user_email.'</td>
       <td style="border: 1px solid; padding:12px;">'.$customer->user_mobile.'</td> 
      </tr>
      ';
     }
     $output .= '</table>';
